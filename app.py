...
if 'BOT_CONFIG' not in globals():
    BOT_CONFIG = {
        "channels": ["@YourChannel1", "@YourChannel2"], # قنوات الاشتراك الإجباري الافتراضية (خاصة بالمطور في الخاص)
...
# --- 4. دالة توليد لوحة التحكم للمطور ---
...
async def callback_handler(event):
    ...
    if data == "admin_stats":
        ...
        current_ch = ", ".join(BOT_CONFIG["channels"]) if BOT_CONFIG["channels"] else "لا يوجد"
